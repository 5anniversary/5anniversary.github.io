...
<br/>CALayer : 각종 view의 세부적인 border 설정
<br/>CGFloat :
<br/>UIButton : button border, shadow
<br/>UIColor : 각종 색 주입, hex로 조절
<br/>UIImage : image 투명도 조절
<br/>UIImageView : Kingfisher 사용
<br/>UITextView : textview의 placeholder추가, textview의 동적인 움직임 
<br/>UIView : superview에 맞는 autolayout , rounding, border
<br/>UIViewcontroller : alertcontroller 
